...
namespace GeronimoGames.Firefly.Game
{
    ...
    {
        [Header("TEXTS")] [SerializeField] private TMP_Text powerUpText;

        [Header("GAME OBJECTS")] [SerializeField]
        private GameObject explosion;

        [SerializeField] private GameObject shield;
        [Header("PREFABS")] [SerializeField] private PlayerBullet bulletBlue;
        [SerializeField] private PlayerBullet bulletRed;
        [SerializeField] private PlayerBullet bulletGreen;
        ...
        [SerializeField] private Transform fire4;
        [SerializeField] private Transform fire5;
        [Header("AUDIO")] [SerializeField] private AudioSource laserSound;

        [Header("COMPONENTS")] [SerializeField]
        private PlayerHealth playerHealth;

        [SerializeField] private Rigidbody2D rigidbody2d;
        [Header("SETTINGS")] [SerializeField] private float moveSpeed = 15.0f;
