...
namespace GeronimoGames.Firefly.Game
{
    ...
    {
        [Header("PREFABS")] [SerializeField] private EnemyBase enemyBomber;
        [SerializeField] private EnemyBase enemyFighter;
        [SerializeField] private EnemyBase enemyOrbWeapon;
