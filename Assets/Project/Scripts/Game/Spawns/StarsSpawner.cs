...
namespace GeronimoGames.Firefly.Game
{
    ...
    {
        [Header("SETTINGS")] [SerializeField] private bool enableBackground = true;
        [SerializeField] private bool onlyWhiteStars;
        [SerializeField] private int maxStars1 = 35;
        [SerializeField] private int maxStars2 = 45;
