...
namespace GeronimoGames.Firefly.Game
{
    ...
    {
        [Header("SETTINGS")] [SerializeField] private bool isHomingWeapon;
        [SerializeField] private float attackRate = 0.50f;
        [SerializeField] private int bulletCount = 1;
        [SerializeField] private Vector3 bulletOffset = new(0, 0.25f, 0);
        [SerializeField] private Vector3 bullet2Offset = new(0, 0.25f, 0);
