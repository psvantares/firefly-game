...
namespace GeronimoGames.Firefly.Game
{
    public class HazardBase : MonoBehaviour
    {
        ...
        [SerializeField] private FloatingCombat floatingCombat;
        [Header("SETTINGS")] [SerializeField] private int maxHealth = 100;
        [SerializeField] private int currentHealth = 100;
        [SerializeField] private float rotationSpeedMin = 25f;
        [SerializeField] private float rotationSpeedMax = 75f;
        [SerializeField] private int pointsValue = 100;
        [Header("AUDIO")] [SerializeField] private AudioSource hazardDestroySound;
