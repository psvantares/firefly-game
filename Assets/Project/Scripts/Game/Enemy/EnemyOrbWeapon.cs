...
namespace GeronimoGames.Firefly.Game
{
    public class EnemyOrbWeapon : MonoBehaviour
    {
        ...
        [SerializeField] private Transform fire6;

        [Header("GAME OBJECTS")] [SerializeField]
        private GameObject enemyBullet;

        [Header("AUDIO")] [SerializeField] private AudioSource fireSound;
        [Header("SETTINGS")] [SerializeField] private float fireDelay = 0.50f;
