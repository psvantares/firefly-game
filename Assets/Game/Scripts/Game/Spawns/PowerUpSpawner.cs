...
namespace Game
{
    ...
    {
        [Header("GAME OBJECTS")]
        [SerializeField] private GameObject bluePowerUp;
        [SerializeField] private GameObject greenPowerUp;
        [SerializeField] private GameObject redPowerUp;
        [SerializeField] private GameObject brownPowerUp;
